...
//  AngryBirds
//
//  Created by Abdelrahman Shehab on 12/05/2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if contact.bodyA.collisionBitMask == ColliderType.Bird.rawValue || contact.bodyB.categoryBitMask == ColliderType.Box.rawValue {
            score += 1
